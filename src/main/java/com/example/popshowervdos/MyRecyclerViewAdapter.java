...
public class MyRecyclerViewAdapter extends RecyclerView.Adapter<MyRecyclerViewAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.laborForce.setText(Double.toString(data_models.get(position).getMalePop()));
        holder.totEmployed.setText(Double.toString(data_models.get(position).getFemalePop()));
        holder.totUnemployed.setText(Double.toString(data_models.get(position).getTotalPop()));
